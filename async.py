...
def start(coroutine, return_value_cb=None):
    """Starts a coroutine running.

    return_value_cb: A callback which will receive the return value of
    the coroutine.
    ...
    passed to return_value_cb, if supplied. If return_value_cb is not
